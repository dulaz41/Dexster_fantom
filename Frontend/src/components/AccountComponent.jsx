            ...
            <>
              ...
              <div className="Assets">
                ...
                <div className="assetBody">
                  <div className="row">
                    <div className="attributeName">Amount of DAI</div>
                    <div className="attributeValue">
                      {props.holding["amountOfDAI"]}
                    </div>
                  </div>
                  <div className="row">
                    <div className="attributeName">Amount of FTM</div>
                    <div className="attributeValue">
                      {props.holding["amountOfFTM"]}
                    </div>
                  </div>
                  <div className="row">
              ...
              <div className="Assets">
                ...
                <div className="assetBody">
                  <div className="row">
                    <div className="attributeName">Total DAI</div>
                    <div className="attributeValue">
                      {props.holding["totalDAI"]}
                    </div>
                  </div>
                  <div className="row">
                    <div className="attributeName">Total FTM</div>
                    <div className="attributeValue">
                      {props.holding["totalFTM"]}
                    </div>
                  </div>
                  <div className="row">
